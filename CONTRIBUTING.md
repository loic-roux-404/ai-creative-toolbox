...
Welcome to `ia-utils` contributor's guide.
...
If you experience bugs or general issues with `ia-utils`, please have a look
...
You can help improve `ia-utils` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ia-utils` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ia-utils`'s files. While this mechanism can
...
```
conda create -n ia-utils python=3 six virtualenv pytest pytest-cov
conda activate ia-utils
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ia-utils.git
   cd ia-utils
   ```
...
5. Install [pre-commit]:
   ...
   `ia-utils` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ia-utils
[issue tracker]: https://github.com/<USERNAME>/ia-utils/issues
